...
kick: s("msn_bd:2").struct("x(5,16)").slow(2)
  .rarely(echo(3, choose(-1/8, 1/8, -1/12, 1/12, -1/16, 1/16), 1/2))
  .mask("[x ~]*2")
...
_hi: "0 1 2 3".fast(2).struct("x(5,8)")
  .chunk(4, x=>x.add("<[0|2] [1|3]>"))
  // .rarely(echo(3, -1/16, 1/2))
  .almostNever(echowith(3, -1/16, (p,n)=>p.add(n).velocity(1-0.33*n)))
  .n()
